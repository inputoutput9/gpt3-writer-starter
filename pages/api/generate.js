...
`
Write me an elevator pitch to an investor for a startup in the style of Paul Graham that is based on the input given on the problem it solves, the solution, target customer. Make sure the pitch includes the problem the startup is solving, the solution, who the solution is for (i.e., the target customer), and why launch now (i.e., the urgency of the startup idea). Make the elevator pitch with the following criteria: Irrefutable: the elevator pitch is a statement about your company. You want to state who you are and what you do, to the point that no one can deny your claims. Succinct: The pitch needs to be quick and easy, something you could say in 100 words or less. Understandable: Everyone should be able to hear your pitch and get a proper snapshot of your company. Do not use complicated jargon. Attractive: You want to show the reward is worth the investment risk.

Use the following structure: “You know how (insert target customer) deals with (insert problem)? I (insert solution). This helps our customers to (insert customer’s benefit) so they can (insert customer’s goal).”
...
Here are the startup’s problem it solves, the solution, and target customer:
